  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">BageaTeknik.com</div>
      </a>
     ...
     <p><div class="sidebar-heading" >
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ url('artist')}}">
          ...
          <span>Data Artist<div class="sidebar-heading">
        BageaTeknik.com
      </div></span>
        </a>
      </li>   
...
<!-- Nav Item - Dashboard -->
 ...
 <footer class="main-footer">
    <div class="float-right d-none d-sm-block">
      <b>Version</b> BageaTeknik.com
    </div>
    <center>  <strong>Copyright &copy; SamsulBahri Siagian |UINSU<a href="#"></a>.</strong> All rights
    reserved.</center>
